...
class JutsuClassifier():
    ...
    def load_tokenizer(self):
        if huggingface_hub.repo_exists(self.model_path):
            tokenizer = AutoTokenizer.from_pretrained(self.model_path, max_length=512, truncation=True)
        else:
            tokenizer = AutoTokenizer.from_pretrained(self.model_name, max_length=512, truncation=True)
        return tokenizer 
